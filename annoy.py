...
bf_mean_time, bf_results = find_nearest_exhaustive(track_vec, ufac_matrix, 500)
...
def make_plot(tree_list):
    ...
    for tree in tqdm(tree_list):
        ...
        for para in [100, 500, 1000, 5000, 10000, 50000, 100000, 500000]:
            algo100_time, algo100_recall = find_nearest_algo(track_vec, ufac_matrix, bf_results, annoy10_wrapped, 500, para)
